...
async def main():
    ...
    pid_info_query.position = moteus.IGNORE
    pid_info_query.velocity = moteus.IGNORE
    pid_info_query.torque = moteus.IGNORE
    ...
    while True:
        ...
        print(f"{curr_cmd.pos} - {v[Register.COMMAND_POSITION]}")
        print(f"{curr_cmd.vel} - {v[Register.COMMAND_VELOCITY]}")
        print(f"{curr_cmd.ff} - {v[Register.COMMAND_FEEDFORWARD_TORQUE]}")
        print("----------")
        msg = f"{v[Register.POSITION_KP]},{v[Register.POSITION_KD]},{v[Register.POSITION_FEEDFORWARD]},{v[Register.POSITION_COMMAND]}"
        # print(msg)
        # log_file.write(f"{cmd_index},{curr_cmd.pos},{curr_cmd.vel},{curr_cmd.ff},{curr_cmd.kp},{curr_cmd.kd},{curr_cmd.max_t},{result.arbitration_id},{reg},{val}\n")
